...
pub const AUTOGEN: &'static str = "// AUTOGEN_NOTICE: this file is automatically generated. Do not change stuff. This file will be overriden without further notice.";

pub const AUTOGEN_PREFIX: &'static str = "// AUTOGEN_NOTICE: ";
...
pub fn build_script<P: AsRef<Path>, Q: AsRef<Path>>(
    ...
    let allow_import = allow_unused
        .then_some("#[allow(unused_imports)]\n")
        .unwrap_or("");
...
fn transform_patch<P: AsRef<Path>, Q: AsRef<Path>>(patch: P, target: Q, allow_unused: bool) {
    ...
    let hook_entry = hook_entry
        .map(|v| format!("Some(MSRAMHookAddress::from_const({}))", v))
        .unwrap_or("None".to_string());

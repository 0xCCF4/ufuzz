...
const CLOCK_TABLE_BYTE_SIZE: usize = size_of::<ClockTableEntry>() * MAX_NUMBER_OF_HOOKS as usize;

pub type ClockTableSettingsEntry = CoverageEntry;
const CLOCK_TABLE_SETTINGS_BYTE_SIZE: usize = size_of::<ClockTableSettingsEntry>() * MAX_NUMBER_OF_HOOKS as usize;

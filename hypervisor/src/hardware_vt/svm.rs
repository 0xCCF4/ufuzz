...
impl hardware_vt::HardwareVt for Svm {
    ...
    fn set_preemption_timer(&self, _timeout_in_tsc: u64) {
    ...
    fn load_state(&mut self, state: &VmState) {
        ...
        let registers = &state.standard_registers;
        let extended_registers = &state.extended_registers;
        ...
        let guest_gdt = extended_registers.gdtr.base as u64;
        self.vmcb.state_save_area.es_selector = extended_registers.es;
        self.vmcb.state_save_area.cs_selector = extended_registers.cs;
        self.vmcb.state_save_area.ss_selector = extended_registers.ss;
        self.vmcb.state_save_area.ds_selector = extended_registers.ds;
        self.vmcb.state_save_area.fs_selector = extended_registers.fs;
        self.vmcb.state_save_area.gs_selector = extended_registers.gs;
        self.vmcb.state_save_area.tr_selector = extended_registers.tr;
        self.vmcb.state_save_area.ldtr_selector = extended_registers.ldtr;
        self.vmcb.state_save_area.es_attrib = get_segment_access_right(guest_gdt, extended_registers.es);
        self.vmcb.state_save_area.cs_attrib = get_segment_access_right(guest_gdt, extended_registers.cs);
        self.vmcb.state_save_area.ss_attrib = get_segment_access_right(guest_gdt, extended_registers.ss);
        self.vmcb.state_save_area.ds_attrib = get_segment_access_right(guest_gdt, extended_registers.ds);
        self.vmcb.state_save_area.fs_attrib = get_segment_access_right(guest_gdt, extended_registers.fs);
        self.vmcb.state_save_area.gs_attrib = get_segment_access_right(guest_gdt, extended_registers.gs);
        self.vmcb.state_save_area.tr_attrib = get_segment_access_right(guest_gdt, extended_registers.tr);
        self.vmcb.state_save_area.ldtr_attrib = get_segment_access_right(guest_gdt, extended_registers.ldtr);
        self.vmcb.state_save_area.es_limit = get_segment_limit(guest_gdt, extended_registers.es);
        self.vmcb.state_save_area.cs_limit = get_segment_limit(guest_gdt, extended_registers.cs);
        self.vmcb.state_save_area.ss_limit = get_segment_limit(guest_gdt, extended_registers.ss);
        self.vmcb.state_save_area.ds_limit = get_segment_limit(guest_gdt, extended_registers.ds);
        self.vmcb.state_save_area.fs_limit = get_segment_limit(guest_gdt, extended_registers.fs);
        self.vmcb.state_save_area.gs_limit = get_segment_limit(guest_gdt, extended_registers.gs);
        self.vmcb.state_save_area.tr_limit = get_segment_limit(guest_gdt, extended_registers.tr);
        self.vmcb.state_save_area.ldtr_limit = get_segment_limit(guest_gdt, extended_registers.ldtr);
        self.vmcb.state_save_area.fs_base = extended_registers.fs_base;
        self.vmcb.state_save_area.gs_base = extended_registers.gs_base;
        self.vmcb.state_save_area.tr_base = extended_registers.tr_base;
        self.vmcb.state_save_area.ldtr_base = extended_registers.ldtr_base;
        // TODO << PAGE_X
        todo!();
        //self.vmcb.state_save_area.gdtr_base = descriptors.gdtr.base as u64;
        //self.vmcb.state_save_area.gdtr_limit = u32::from(descriptors.gdtr.limit);
        //self.vmcb.state_save_area.idtr_base = descriptors.idtr.base as u64;
        //self.vmcb.state_save_area.idtr_limit = u32::from(descriptors.idtr.limit);
        self.vmcb.state_save_area.sysenter_cs = extended_registers.sysenter_cs;
        self.vmcb.state_save_area.sysenter_esp = extended_registers.sysenter_esp;
        self.vmcb.state_save_area.sysenter_eip = extended_registers.sysenter_eip;
        self.vmcb.state_save_area.efer = extended_registers.efer | EFER_SVME;
        self.vmcb.state_save_area.cr0 = extended_registers.cr0;
        self.vmcb.state_save_area.cr3 = extended_registers.cr3;
        self.vmcb.state_save_area.cr4 = extended_registers.cr4 & !CR4_VMXE;
        ...
        self.registers.xmm0 = registers.xmm0;
        self.registers.xmm1 = registers.xmm1;
        self.registers.xmm2 = registers.xmm2;
        self.registers.xmm3 = registers.xmm3;
        self.registers.xmm4 = registers.xmm4;
        self.registers.xmm5 = registers.xmm5;
        self.registers.xmm6 = registers.xmm6;
        self.registers.xmm7 = registers.xmm7;
        self.registers.xmm8 = registers.xmm8;
        self.registers.xmm9 = registers.xmm9;
        self.registers.xmm10 = registers.xmm10;
        self.registers.xmm11 = registers.xmm11;
        self.registers.xmm12 = registers.xmm12;
